...
instructor: ["Timo Gnadt", "Hanna Varachkina", "Raisa Barthauer", "Julika Mimkes", "Péter Király", "Birgit Schmidt"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Britta Timmermann", "Harald Kusch", "Astrid Orth", "Laura Botzet", "Ubbo Veentjer"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
